...
import com.abc.sports.R
import com.abc.sports.data.LocalSportsDataProvider
import com.abc.sports.model.Sport
import com.abc.sports.ui.theme.SportsTheme
import com.abc.sports.utils.SportsContentType
 ...
 */
@Composable
fun SportsApp(screenSize: WindowWidthSizeClass, onBackPressed: () -> Unit) {
    val viewModel: SportsViewModel = viewModel()
    val uiState by viewModel.uiState.collectAsState()

    val contentType = when (screenSize) {
    ...
    Scaffold(
        topBar = {
            SportsAppBar(
                // Should be true when ListAndDetail
                // I did: isShowingListPage = contentType == SportsContentType.ListAndDetail || uiState.isShowingListPage,
...
fun SportsAppBar(
    ...
    val isShowingDetailPage = screenSize != WindowWidthSizeClass.Expanded && !isShowingListPage
    TopAppBar(
        title = {
            Text(
                text =
